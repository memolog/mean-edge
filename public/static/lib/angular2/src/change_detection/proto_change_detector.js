...
var DynamicProtoChangeDetector = (function (_super) {
    ...
    DynamicProtoChangeDetector.prototype.instantiate = function (dispatcher) {
        ...
        return new dynamic_change_detector_1.DynamicChangeDetector(this._changeControlStrategy, dispatcher, this._pipeRegistry, this._records, this._directiveRecords);
    };
    DynamicProtoChangeDetector.prototype._createRecordsIfNecessary = function () {
        var _this = this;
        if (lang_1.isBlank(this._records)) {
            var recordBuilder = new ProtoRecordBuilder();
            collection_1.ListWrapper.forEach(this._bindingRecords, function (b) { recordBuilder.addAst(b, _this._variableBindings); });
...
var JitProtoChangeDetector = (function (_super) {
    ...
    JitProtoChangeDetector.prototype._createFactoryIfNecessary = function () {
        var _this = this;
        if (lang_1.isBlank(this._factory)) {
            ...
            this._factory = new change_detection_jit_generator_1.ChangeDetectorJITGenerator(typeName, this._changeControlStrategy, records, this._directiveRecords)
                .generate();
        }
    };
...
var ProtoRecordBuilder = (function () {
    ...
    ProtoRecordBuilder.prototype.addAst = function (b, variableBindings) {
        if (variableBindings === void 0) { variableBindings = null; }
        var last = collection_1.ListWrapper.last(this.records);
        if (lang_1.isPresent(last) && last.bindingRecord.directiveRecord == b.directiveRecord) {
...
var _ConvertAstIntoProtoRecords = (function () {
    ...
    _ConvertAstIntoProtoRecords.convert = function (b, contextIndex, variableBindings) {
        var c = new _ConvertAstIntoProtoRecords(b, contextIndex, b.ast.toString(), variableBindings);
        b.ast.visit(c);
        return c.protoRecords;
    };
    _ConvertAstIntoProtoRecords.prototype.visitImplicitReceiver = function (ast) { return this.bindingRecord.implicitReceiver; };
    ...
    _ConvertAstIntoProtoRecords.prototype._addRecord = function (type, name, funcOrValue, args, fixedArgs, context) {
        ...
        if (context instanceof directive_record_1.DirectiveIndex) {
            collection_1.ListWrapper.push(this.protoRecords, new proto_record_1.ProtoRecord(type, name, funcOrValue, args, fixedArgs, -1, context, selfIndex, this.bindingRecord, this.expressionAsString, false, false));
        }
        else {
            collection_1.ListWrapper.push(this.protoRecords, new proto_record_1.ProtoRecord(type, name, funcOrValue, args, fixedArgs, context, null, selfIndex, this.bindingRecord, this.expressionAsString, false, false));
        }
        return selfIndex;
    };
