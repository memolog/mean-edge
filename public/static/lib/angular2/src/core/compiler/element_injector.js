...
var $__4 = ($__angular2_47_di__ = require("angular2/di"), $__angular2_47_di__ && $__angular2_47_di__.__esModule && $__angular2_47_di__ || {default: $__angular2_47_di__}),
    ...
    bind = $__4.bind,
    Binding = $__4.Binding,
    ResolvedBinding = $__4.ResolvedBinding,
    NoBindingError = $__4.NoBindingError,
    AbstractBindingError = $__4.AbstractBindingError,
    CyclicDependencyError = $__4.CyclicDependencyError;
var $__5 = ($__angular2_47_src_47_core_47_annotations_95_impl_47_visibility__ = require("angular2/src/core/annotations_impl/visibility"), $__angular2_47_src_47_core_47_annotations_95_impl_47_visibility__ && $__angular2_47_src_47_core_47_annotations_95_impl_47_visibility__.__esModule && $__angular2_47_src_47_core_47_annotations_95_impl_47_visibility__ || {default: $__angular2_47_src_47_core_47_annotations_95_impl_47_visibility__}),
    Parent = $__5.Parent,
    Ancestor = $__5.Ancestor;
var $__6 = ($__angular2_47_src_47_core_47_annotations_95_impl_47_di__ = require("angular2/src/core/annotations_impl/di"), $__angular2_47_src_47_core_47_annotations_95_impl_47_di__ && $__angular2_47_src_47_core_47_annotations_95_impl_47_di__.__esModule && $__angular2_47_src_47_core_47_annotations_95_impl_47_di__ || {default: $__angular2_47_src_47_core_47_annotations_95_impl_47_di__}),
...
var $__9 = ($__view_95_ref__ = require("./view_ref"), $__view_95_ref__ && $__view_95_ref__.__esModule && $__view_95_ref__ || {default: $__view_95_ref__}),
    ProtoViewRef = $__9.ProtoViewRef,
    ViewRef = $__9.ViewRef;
var $__10 = ($__angular2_47_src_47_core_47_annotations_95_impl_47_annotations__ = require("angular2/src/core/annotations_impl/annotations"), $__angular2_47_src_47_core_47_annotations_95_impl_47_annotations__ && $__angular2_47_src_47_core_47_annotations_95_impl_47_annotations__.__esModule && $__angular2_47_src_47_core_47_annotations_95_impl_47_annotations__ || {default: $__angular2_47_src_47_core_47_annotations_95_impl_47_annotations__}),
    ...
    Component = $__10.Component,
    onChange = $__10.onChange,
    onDestroy = $__10.onDestroy,
    onAllChangesDone = $__10.onAllChangesDone;
var $__11 = ($__angular2_47_change_95_detection__ = require("angular2/change_detection"), $__angular2_47_change_95_detection__ && $__angular2_47_change_95_detection__.__esModule && $__angular2_47_change_95_detection__ || {default: $__angular2_47_change_95_detection__}),
    ChangeDetector = $__11.ChangeDetector,
    ChangeDetectorRef = $__11.ChangeDetectorRef;
...
Object.defineProperty(DirectiveDependency, "parameters", {get: function() {
    return [[Key], [$traceurRuntime.type.boolean], [$traceurRuntime.type.boolean], [$traceurRuntime.type.boolean], [List], [int], [$traceurRuntime.type.string], []];
  }});
...
($traceurRuntime.createClass)(ProtoElementInjector, {
  ...
  _createHostActionAccessors: function(b) {
    var res = [];
    StringMapWrapper.forEach(b.hostActions, (function(actionExpression, actionName) {
...
($traceurRuntime.createClass)(ElementInjector, {
  ...
  instantiateDirectives: function(lightDomAppInjector, host, preBuiltObjects) {
    ...
    if (isPresent(shadowDomAppInjector)) {
      var componentAnnotation = this._proto._binding0.annotation;
      ...
      if (isPresent(publishAs) && publishAs.length > 0) {
        this._shadowDomAppInjector = shadowDomAppInjector.resolveAndCreateChild(ListWrapper.map(publishAs, (function(token) {
          return bind(token).toValue($__14.getComponent());
        })));
      }
    }
