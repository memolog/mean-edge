...
var appComponentAnnotatedTypeToken = ($__src_47_core_47_application_95_tokens__ = require("./src/core/application_tokens"), $__src_47_core_47_application_95_tokens__ && $__src_47_core_47_application_95_tokens__.__esModule && $__src_47_core_47_application_95_tokens__ || {default: $__src_47_core_47_application_95_tokens__}).appComponentAnnotatedTypeToken;
var bind = ($__di__ = require("./di"), $__di__ && $__di__.__esModule && $__di__ || {default: $__di__}).bind;
var routerInjectables = [RouteRegistry, Pipeline, BrowserLocation, Location, bind(Router).toFactory((function(registry, pipeline, location, meta) {
