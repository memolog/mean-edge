...
import {Router,
  RootRouter} from './src/router/router';
...
import {bind} from './di';
export var routerInjectables = [RouteRegistry, Pipeline, BrowserLocation, Location, bind(Router).toFactory((registry, pipeline, location, meta) => {
