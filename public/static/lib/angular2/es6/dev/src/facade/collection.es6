...
export class MapWrapper {
    ...
    static clone(m) { return new Map(m); }
    ...
    static createFromPairs(pairs) { return new Map(pairs); }
...
export class ListWrapper {
    ...
    static sort(l, compareFn) { l.sort(compareFn); }
}
...
export class SetWrapper {
    static createFromList(lst) { return new Set(lst); }
