System.register(["angular2/src/facade/collection", "angular2/src/facade/async", "angular2/change_detection", "../../api", "./compile_step", "./property_binding_parser", "./text_interpolation_parser", "./directive_parser", "./view_splitter", "../shadow_dom/shadow_dom_compile_step", "../shadow_dom/shadow_dom_strategy"], function($__export) {
  "use strict";
  var List,
      Promise,
      Parser,
