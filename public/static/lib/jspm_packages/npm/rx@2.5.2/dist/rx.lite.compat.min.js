...
(function(process) {
  (function(a) {
    ...
    function i(a) {
      ...
      if (!Za(a))
        return b;
      Ya.nonEnumArgs && a.length && $a(a) && (a = cb.call(a));
      var c = Ya.enumPrototypes && "function" == typeof a,
          d = Ya.enumErrorProps && (a === Ta || a instanceof Error);
      for (var e in a)
        c && "prototype" == e || d && ("message" == e || "name" == e) || b.push(e);
      if (Ya.nonEnumShadows && a !== Ua) {
        var f = a.constructor,
            g = -1,
            h = Fa;
        if (a === (f && f.prototype))
          var i = a === Va ? Pa : a === Ta ? Ka : Qa.call(a),
              j = Xa[i];
        for (; ++g < h; )
          e = Ea[g], j && j[e] || !Ra.call(a, e) || b.push(e);
      }
      return b;
    }
    function j(a, b, c) {
    ...
    function m(a, b, c, d) {
      ...
      var i = g == Ha;
      if (!i) {
        if (g != Na || !Ya.nodeClass && (l(a) || l(b)))
          return !1;
        var j = !Ya.argsObject && $a(a) ? Object : a.constructor,
            n = !Ya.argsObject && $a(b) ? Object : b.constructor;
        if (!(j == n || Ra.call(a, "constructor") && Ra.call(b, "constructor") || la(j) && j instanceof j && la(n) && n instanceof n || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
      ...
      if (c.push(a), d.push(b), i) {
        ...
        k(b, function(b, e, f) {
          return Ra.call(f, e) ? (p++, q = Ra.call(a, e) && m(a[e], b, c, d)) : void 0;
        }), q && k(a, function(a, b, c) {
          return Ra.call(c, b) ? q = --p > -1 : void 0;
        });
    ...
    function z(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new u(b), c[ya]();
      if (!d && b.length !== a)
        return c = new w(b), c[ya]();
      if (!d)
    ...
    function B(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && y(b) ? (b = A(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > $b ? $b : b) : b;
    }
    function C(a, b) {
      this.observer = a, this.parent = b;
    }
    function D(a, b) {
      return vb(a) || (a = zb), new ac(b, a);
    }
    function E(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function K(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ka(e) && (e = wc(e)), (Ba(e) || Aa(e)) && (e = _b(e)), e;
      }).concatAll();
    }
    function L(a, b, c) {
    ...
    function P(a, b, c) {
      ...
      if (a.attachEvent) {
        ...
        return a.attachEvent("on" + b, d), mb(function() {
          a.detachEvent("on" + b, d);
        });
      }
      return a["on" + b] = c, mb(function() {
        a["on" + b] = null;
      });
    }
    function Q(a, b, c) {
    ...
    function T(a, b) {
      return new Dc(function(c) {
        return b.scheduleWithRelative(ub(a), function() {
          c.onNext(0), c.onCompleted();
        });
      });
    }
    function U(a, b, c) {
      return a === b ? new Dc(function(a) {
        return c.schedulePeriodicWithState(0, b, function(b) {
          return a.onNext(b), b + 1;
        });
      }) : Vb(function() {
        return S(c.now() + a, b, c);
      });
    }
    function V(a, b, c) {
      return new Dc(function(d) {
 ...
 while (null !== g);
    ...
    var Z = {
      ...
      undefined: !1
        ...
        _ = Z[typeof exports] && exports && !exports.nodeType && exports,
        aa = Z[typeof module] && module && !module.nodeType && module,
    ...
    var da = {
      ...
      helpers: {}
        ...
        }, da.helpers.defaultNow = function() {
        ...
        la = (da.helpers.asArray = function() {
          ...
          return !a;
        }, da.helpers.isFunction = function() {
          var a = function(a) {
            return "function" == typeof a || !1;
          };
          return a(/x/) && (a = function(a) {
            return "function" == typeof a && "[object Function]" == Qa.call(a);
          }), a;
        }());
    ...
    var oa,
        ...
        ra = da.EmptyError = function() {
          this.message = "Sequence contains no elements.", Error.call(this);
        };
    ra.prototype = Error.prototype;
    var sa = da.ObjectDisposedError = function() {
      this.message = "Object has been disposed", Error.call(this);
    };
    sa.prototype = Error.prototype;
    var ta = da.ArgumentOutOfRangeError = function() {
      this.message = "Argument out of range", Error.call(this);
    };
    ta.prototype = Error.prototype;
    var ua = da.NotSupportedError = function(a) {
      this.message = a || "This operation is not supported", Error.call(this);
    };
    ua.prototype = Error.prototype;
    var va = da.NotImplementedError = function(a) {
      this.message = a || "This operation is not implemented", Error.call(this);
    };
    va.prototype = Error.prototype;
    var wa = da.helpers.notImplemented = function() {
      throw new va;
    },
        xa = da.helpers.notSupported = function() {
          throw new ua;
        },
        ya = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    $.Set && "function" == typeof(new $.Set)["@@iterator"] && (ya = "@@iterator");
    var za = da.doneEnumerator = {
      done: !0,
      value: a
    },
        Aa = da.helpers.isIterable = function(b) {
          return b[ya] !== a;
        },
        Ba = da.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    da.helpers.iterator = ya;
    var Ca,
        Da = da.internals.bindCallback = function(a, b, c) {
        ...
        Ea = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"],
        Fa = Ea.length,
        Ga = "[object Arguments]",
        Ha = "[object Array]",
        Ia = "[object Boolean]",
        ...
        Sa = Qa.call(arguments) == Ga,
        Ta = Error.prototype,
        Ua = Object.prototype,
        Va = String.prototype,
        Wa = Ua.propertyIsEnumerable;
    try {
      Ca = !(Qa.call(document) == Na && !({toString: 0} + ""));
    } catch (na) {
      Ca = !0;
    }
    var Xa = {};
    ...
    !function() {
      ...
      for (c in arguments)
        ;
      Ya.enumErrorProps = Wa.call(Ta, "message") || Wa.call(Ta, "name"), Ya.enumPrototypes = Wa.call(a, "prototype"), Ya.nonEnumArgs = 0 != c, Ya.nonEnumShadows = !/valueOf/.test(b);
    }(1);
    var Za = da.internals.isObject = function(a) {
      var b = typeof a;
      return a && ("function" == b || "object" == b) || !1;
    },
        $a = function(a) {
          return a && "object" == typeof a ? Qa.call(a) == Ga : !1;
        };
    Sa || ($a = function(a) {
      return a && "object" == typeof a ? Ra.call(a, "callee") : !1;
    });
    {
      var _a,
          ab = da.internals.isEqual = function(a, b) {
            return m(a, b, [], []);
          },
          bb = {e: {}},
      ...
      da.internals.addRef = function(a, b) {
        return new Dc(function(c) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
      var b = this,
          c = cb.call(arguments, 1),
          d = function() {
            function e() {}
            if (this instanceof d) {
              e.prototype = b.prototype;
              var f = new e,
                  g = b.apply(f, c.concat(cb.call(arguments)));
              return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(cb.call(arguments)));
          };
      return d;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = gb && {}.toString.call(this) == Pa ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if ({}.toString.call(a) != La)
        throw new TypeError(a + " is not a function");
      for (var f = 0; d > f; f++)
    ...
    }(), da.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || ia, this.disposable = new qb;
    });
    sb.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, sb.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, sb.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, sb.prototype.invokeCore = function() {
      return this.action(this.scheduler, this.state);
    };
    var tb = da.Scheduler = function() {
      function a(a, b, c, d) {
    ...
    !function(a) {
      ...
      tb.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, tb.prototype.schedulePeriodicWithState = function(a, b, c) {
    ...
    var wb,
        xb,
        yb = tb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new tb(ga, a, xa, xa);
        }(),
        zb = tb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
          ...
          function b(b, d) {
            var e = new sb(this, b, d, this.now());
            if (c)
              c.enqueue(e);
            else {
        ...
        Ab = (da.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
    ...
    !function() {
      ...
      var g = RegExp("^" + String(Qa).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
      ...
      if (la(h))
        ...
        $.addEventListener ? $.addEventListener("message", c, !1) : $.attachEvent ? $.attachEvent("onmessage", c) : $.onmessage = c, wb = function(a) {
          var b = d++;
          return e[b] = a, $.postMessage(i + currentId, "*"), b;
        };
        ...
        wb = "document" in $ && "onreadystatechange" in $.document.createElement("script") ? function(b) {
          var c = $.document.createElement("script"),
              f = d++;
          return e[f] = b, c.onreadystatechange = function() {
            a(f), c.onreadystatechange = null, c.parentNode.removeChild(c), c = null;
          }, $.document.documentElement.appendChild(c), f;
        } : function(b) {
          var c = d++;
    ...
    var Db = tb.timeout = tb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new qb,
            e = wb(function() {
      ...
      return new tb(ga, a, b, c);
    }(),
        Eb = da.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return vb(a) || (a = yb), new Dc(function(c) {
        ...
        Fb = Eb.createOnNext = function() {
          ...
          return function(d) {
            return new Eb("N", d, null, a, b, c);
          };
        }(),
        Gb = Eb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new Eb("E", null, d, a, b, c);
          };
        }(),
        Hb = Eb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new Eb("C", null, null, a, b, c);
          };
        }(),
        Ib = da.internals.Enumerator = function(a) {
          this._next = a;
        };
    Ib.prototype.next = function() {
      return this._next();
    }, Ib.prototype[ya] = function() {
      return this;
    };
    var Jb = da.internals.Enumerable = function(a) {
      this._iterator = a;
    };
    Jb.prototype[ya] = function() {
      return this._iterator();
    }, Jb.prototype.concat = function() {
      var a = this;
      return new Dc(function(b) {
        var c,
            d = a[ya](),
            e = new rb,
            f = yb.scheduleRecursive(function(a) {
              if (!c) {
                try {
                  var f = d.next();
                } catch (g) {
    ...
    }, Jb.prototype.catchError = function() {
      var a = this;
      return new Dc(function(b) {
        var c,
            d = a[ya](),
            e = new rb,
            f = yb.scheduleRecursiveWithState(null, function(a, f) {
              if (!c) {
                try {
                  var g = d.next();
                } catch (h) {
    ...
    }, Jb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Dc(function(c) {
        var d,
            e,
            ...
            j = b[ya](),
            k = new rb,
            l = yb.scheduleRecursive(function(a) {
              if (!d) {
                try {
                  var b = j.next();
                } catch (h) {
    ...
    var Kb,
        Lb = Jb.repeat = function(a, b) {
          return null == b && (b = -1), new Jb(function() {
            var c = b;
        ...
        Mb = Jb.of = function(a, b, c) {
          if (b)
            var d = Da(b, c, 3);
          return new Jb(function() {
            var c = -1;
            return new Ib(function() {
              return ++c < a.length ? {
                done: !1,
        ...
        Nb = da.Observer = function() {},
        Ob = Nb.create = function(a, b, c) {
          return a || (a = ea), b || (b = ja), c || (c = ea), new Qb(a, b, c);
        },
        Pb = da.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1, a.call(this);
          }
          return db(b, a), b.prototype.next = wa, b.prototype.error = wa, b.prototype.completed = wa, b.prototype.onNext = function(a) {
        ...
        Qb = da.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Rb = da.Observable = function() {
          function a(a) {
            if (da.config.longStackSupport && ma) {
              try {
                throw new Error;
              } catch (b) {
          ...
          return Kb = a.prototype, Kb.subscribe = Kb.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Ob(a, b, c));
          }, Kb.subscribeOnNext = function(a, b) {
            return this._subscribe(Ob("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Kb.subscribeOnError = function(a, b) {
            return this._subscribe(Ob(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Kb.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Ob(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        Sb = da.ObservableBase = function(a) {
          function b(a) {
            return a && la(a.dispose) ? a : la(a) ? mb(a) : nb;
          }
          function c(a, c) {
            var d = c[0],
                e = c[1],
                f = o(e.subscribeCore).call(e, d);
            return f !== bb || d.fail(bb.e) ? void d.setDisposable(b(f)) : p(bb.e);
          }
          function d(a) {
            var b = new Ec(a),
                d = [b, this];
            return zb.scheduleRequired() ? zb.scheduleWithState(d, c) : c(null, d), b;
          }
          function e() {
            a.call(this, d);
          }
          return db(e, a), e.prototype.subscribeCore = wa, e;
        }(Rb),
        Tb = da.internals.ScheduledObserver = function(a) {
          function b(b, c) {
    ...
    t.prototype.onNext = function(a) {
      ...
      return new Ub(this);
    }, Rb.create = Rb.createWithDisposable = function(a, b) {
      return new Dc(a, b);
    };
    var Vb = Rb.defer = function(a) {
      return new Dc(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return jc(d).subscribe(b);
        }
        return ka(c) && (c = wc(c)), c.subscribe(b);
      });
    },
        Wb = function(a) {
          function b(b) {
        ...
        Xb = Rb.empty = function(a) {
          return vb(a) || (a = yb), new Wb(a);
        },
        Yb = function(a) {
          function b(b, c, d) {
    ...
    var _b = Rb.from = function(a, b, c, d) {
      if (null == a)
    ...
    {
      var bc = Rb.fromArray = function(a, b) {
        return vb(b) || (b = zb), new ac(a, b);
      },
          cc = function(a) {
            function b() {
              a.call(this);
    ...
    E.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Rb.pairs = function(a, b) {
      return b || (b = zb), new dc(a, b);
    };
    var ec = function(a) {
      function b(b, c, d) {
    ...
    Rb.range = function(a, b, c) {
      return vb(c) || (c = zb), new ec(a, b, c);
    };
    var gc = function(a) {
      function b(b, c, d) {
    ...
    }, Rb.repeat = function(a, b, c) {
      return vb(c) || (c = zb), new gc(a, b, c);
    };
    var hc = function(a) {
      function b(b, c) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        ic = (Rb["return"] = Rb.just = Rb.returnValue = function(a, b) {
          return vb(b) || (b = yb), new hc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        jc = Rb["throw"] = Rb.throwError = Rb.throwException = function(a, b) {
          return vb(b) || (b = yb), new ic(a, b);
        };
    Kb["catch"] = Kb.catchError = Kb.catchException = function(a) {
      return "function" == typeof a ? G(this, a) : kc([this, a]);
    };
    var kc = Rb.catchError = Rb["catch"] = Rb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
        for (var b = 0,
          ...
          a.push(arguments[b]);
      return Mb(a).catchError();
    };
    Kb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), lc.apply(this, b);
    };
    var lc = Rb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new Dc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new qb;
            ka(f) && (f = wc(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Kb.concat = function() {
      for (var a = [],
          ...
          c = arguments.length; c > b; b++)
        a.push(arguments[b]);
      return a.unshift(this), mc.apply(null, a);
    };
    var mc = Rb.concat = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    Kb.concatAll = Kb.concatObservable = function() {
      return this.merge(1);
    };
    var nc = function(a) {
      function b(b, c) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        var b = new jb;
        return b.add(this.source.subscribe(new oc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Sb),
        oc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new qb;
            this.g.add(c), ka(a) && (a = wc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Kb.merge = function(a) {
      return "number" != typeof a ? pc(this, a) : new nc(this, a);
    };
    var pc = Rb.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), D(a, c).mergeAll();
        ...
        qc = function(a) {
          ...
          return db(b, a), b.prototype.subscribeCore = function(a) {
            var b = new jb,
                c = new qb;
            return b.add(c), c.setDisposable(this.source.subscribe(new rc(a, b))), b;
          }, b;
        }(Sb),
        rc = function() {
          function a(a, b) {
          ...
          return a.prototype.onNext = function(a) {
            if (!this.isStopped) {
              var c = new qb;
              this.g.add(c), ka(a) && (a = wc(a)), c.setDisposable(a.subscribe(new b(this, this.g, c)));
            }
          }, a.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, a.prototype.onCompleted = function() {
    ...
    Kb.mergeAll = Kb.mergeObservable = function() {
      return new qc(this);
    };
    var sc = da.CompositeError = function(a) {
    ...
    sc.prototype = Error.prototype, Rb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      var d = D(null, a);
      return new Dc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new sc(g));
        }
        var c = new jb,
            e = new qb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new qb;
          c.add(e), ka(d) && (d = wc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, Kb["switch"] = Kb.switchLatest = function() {
      var a = this;
      return new Dc(function(b) {
        var c = !1,
            d = new rb,
            ...
            g = a.subscribe(function(a) {
              var g = new qb,
                  h = ++f;
              c = !0, d.setDisposable(g), ka(a) && (a = wc(a)), g.setDisposable(a.subscribe(function(a) {
                f === h && b.onNext(a);
              }, function(a) {
                f === h && b.onError(a);
              }, function() {
    ...
    }, Kb.takeUntil = function(a) {
      var b = this;
      return new Dc(function(c) {
        return ka(a) && (a = wc(a)), new jb(b.subscribe(c), a.subscribe(function() {
          c.onCompleted();
        }, function(a) {
          c.onError(a);
        }, ea));
      }, b);
    }, Kb.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Dc(function(a) {
        for (var c = function() {
          ...
          !function(c) {
            var d = b[c],
                e = new qb;
            ka(d) && (d = wc(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new Dc(function(a) {
        function c(b) {
          var c,
              f;
        ...
        for (var g = b.length,
          ...
          !function(d) {
            var e = b[d],
                g = new qb;
            ka(e) && (e = wc(e)), g.setDisposable(e.subscribe(function(a) {
              h[d].push(a), c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    }, Kb.asObservable = function() {
      var a = this;
      return new Dc(function(b) {
        return a.subscribe(b);
      }, this);
    }, Kb.dematerialize = function() {
      var a = this;
      return new Dc(function(b) {
    ...
    }, Kb.distinctUntilChanged = function(a, b) {
      var c = this;
      return b || (b = ha), new Dc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    }, Kb["do"] = Kb.tap = Kb.doAction = function(a, b, c) {
      var d = this;
      return new Dc(function(e) {
        var f = !a || la(a) ? Ob(a || ea, b || ea, c || ea) : a;
    ...
    }, Kb.doOnNext = Kb.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Kb.doOnError = Kb.tapOnError = function(a, b) {
      return this.tap(ea, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Kb.doOnCompleted = Kb.tapOnCompleted = function(a, b) {
      return this.tap(ea, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Kb["finally"] = Kb.ensure = function(a) {
      var b = this;
      return new Dc(function(c) {
        var d;
        try {
    ...
    }, Kb.finallyAction = function(a) {
      return this.ensure(a);
    }, Kb.ignoreElements = function() {
      var a = this;
      return new Dc(function(b) {
    ...
    }, Kb.materialize = function() {
      var a = this;
      return new Dc(function(b) {
        return a.subscribe(function(a) {
          b.onNext(Fb(a));
        }, function(a) {
          b.onNext(Gb(a)), b.onCompleted();
        }, function() {
          b.onNext(Hb()), b.onCompleted();
        });
      }, a);
    }, Kb.repeat = function(a) {
      return Lb(this, a).concat();
    }, Kb.retry = function(a) {
      return Lb(this, a).catchError();
    }, Kb.retryWhen = function(a) {
      return Lb(this).catchErrorWhen(a);
    }, Kb.scan = function() {
      var a,
          b,
          c = !1,
          d = this;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new Dc(function(e) {
        var f,
            g,
            h;
    ...
    }, Kb.startWith = function() {
      var a,
          b = 0;
      arguments.length && vb(arguments[0]) ? (a = arguments[0], b = 1) : a = yb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Mb([bc(c, a), this]).concat();
    }, Kb.takeLast = function(a) {
      if (0 > a)
        throw new ta;
      var b = this;
      return new Dc(function(c) {
    ...
    }, Kb.selectConcat = Kb.concatMap = function(a, b, c) {
      return la(a) && la(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ka(e) && (e = wc(e)), (Ba(e) || Aa(e)) && (e = _b(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : la(a) ? K(this, a, c) : K(this, function() {
        return a;
      });
    };
    var tc = function(a) {
      function b(b, c, d) {
        this.source = b, this.selector = Da(c, d, 3), a.call(this);
      }
    ...
    L.prototype.onNext = function(a) {
      if (!this.isStopped) {
        ...
        return b === bb ? this.observer.onError(b.e) : void this.observer.onNext(b);
      }
      ...
      return this.isStopped ? !1 : (this.isStopped = !0, this.observer.onError(a), !0);
    }, Kb.map = Kb.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof tc ? this.internalMap(c, b) : new tc(this, c, b);
    }, Kb.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, Kb.selectMany = Kb.flatMap = function(a, b, c) {
      return la(a) && la(b) ? this.flatMap(function(c, d) {
        var e = a(c, d);
        return ka(e) && (e = wc(e)), (Ba(e) || Aa(e)) && (e = _b(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }, c) : la(a) ? M(this, a, c) : M(this, function() {
        return a;
      });
    }, Kb.selectSwitch = Kb.flatMapLatest = Kb.switchMap = function(a, b) {
    ...
    var uc = function(a) {
      function b(b, c, d) {
        this.source = b, this.predicate = Da(c, d, 3), a.call(this);
      }
      return db(b, a), b.prototype.subscribeCore = function(a) {
    ...
    N.prototype.onNext = function(a) {
      if (!this.isStopped) {
        ...
        return b === bb ? this.observer.onError(b.e) : void(b && this.observer.onNext(a));
      }
      ...
      return this.isStopped ? !1 : (this.isStopped = !0, this.observer.onError(a), !0);
    }, Kb.filter = Kb.where = function(a, b) {
      return this instanceof uc ? this.internalFilter(a, b) : new uc(this, a, b);
    }, Rb.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, Rb.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, da.config.useNativeEvents = !1, Rb.fromEvent = function(a, b, c) {
      return a.addListener ? vc(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : da.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Dc(function(d) {
        return Q(a, b, function(a) {
          var b = a;
          if (c)
            try {
              b = c(arguments);
      ...
      }).publish().refCount() : vc(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var vc = Rb.fromEventPattern = function(a, b, c) {
      return new Dc(function(d) {
        function e(a) {
          var b = a;
          if (c)
    ...
    Kb.toPromise = function(a) {
      if (a || (a = da.config.Promise), !a)
        throw new ua("Promise type not provided nor in Rx.config.Promise");
      var b = this;
      ...
      return wc(b);
    }, Kb.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new Dc(function(d) {
        var e = c.multicast(a());
        return new jb(b(e).subscribe(d), e.connect());
      }, c) : new xc(c, a);
    }, Kb.publish = function(a) {
      return a && la(a) ? this.multicast(function() {
        return new Gc;
      }, a) : this.multicast(new Gc);
    }, Kb.share = function() {
      return this.publish().refCount();
    }, Kb.publishLast = function(a) {
      return a && la(a) ? this.multicast(function() {
        return new Hc;
      }, a) : this.multicast(new Hc);
    }, Kb.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Jc(b);
      }, a) : this.multicast(new Jc(a));
    }, Kb.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, Kb.replay = function(a, b, c, d) {
      return a && la(a) ? this.multicast(function() {
        return new Kc(b, c, d);
      }, a) : this.multicast(new Kc(b, c, d));
    }, Kb.shareReplay = function(a, b, c) {
      return this.replay(null, a, b, c).refCount();
    };
    {
      var xc = da.ConnectableObservable = function(a) {
        function b(b, c) {
          var d,
              e = !1,
              f = b.asObservable();
        ...
        return db(b, a), b.prototype.refCount = function() {
          ...
          yc = Rb.interval = function(a, b) {
            return U(a, a, vb(b) ? b : Db);
          };
      Rb.timer = function(b, c, d) {
        var e;
        return vb(d) || (d = Db), c !== a && "number" == typeof c ? e = c : vb(c) && (d = c), b instanceof Date && e === a ? R(b.getTime(), d) : b instanceof Date && e !== a ? (e = c, S(b.getTime(), e, d)) : e === a ? T(b, d) : U(b, e, d);
      };
    }
    Kb.delay = function(a, b) {
      return vb(b) || (b = Db), a instanceof Date ? W(this, a.getTime(), b) : V(this, a, b);
    }, Kb.debounce = Kb.throttleWithTimeout = function(a, b) {
      vb(b) || (b = Db);
      var c = this;
      return new Dc(function(d) {
        var e,
    ...
    }, Kb.throttle = function(a, b) {
      return this.debounce(a, b);
    }, Kb.timestamp = function(a) {
      return vb(a) || (a = Db), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, Kb.sample = Kb.throttleLatest = function(a, b) {
      return vb(b) || (b = Db), "number" == typeof a ? X(this, yc(a, b)) : X(this, a);
    }, Kb.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = jc(new Error(b || "Timeout"))), vb(c) || (c = Db);
      var d = this,
          e = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Dc(function(f) {
        function g() {
          var d = h;
          l.setDisposable(c[e](a, function() {
            h === d && (ka(b) && (b = wc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new qb,
    ...
    var zc = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Gc, this.pauser = d && d.subscribe ? this.controller.merge(d) : this.controller, a.call(this, b, c);
      }
    ...
    var Ac = function(b) {
      ...
      function d(a, d) {
        this.source = a, this.controller = new Gc, this.pauser = d && d.subscribe ? this.controller.merge(d) : this.controller, b.call(this, c, a);
      }
    ...
    Kb.pausableBuffered = function(a) {
    ...
    var Bc = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Cc(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return db(c, a), c.prototype.request = function(a) {
        ...
        Cc = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Gc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = nb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || zb;
          }
          return db(c, a), eb(c.prototype, Nb, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Eb.createOnCompleted()) : this.subject.onCompleted();
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Eb.createOnError(a)) : this.subject.onError(a);
            },
            onNext: function(a) {
              var b = !1;
              0 === this.requestedCount ? this.enableQueue && this.queue.push(Eb.createOnNext(a)) : (-1 !== this.requestedCount && 0 === this.requestedCount-- && this.disposeCurrentRequest(), b = !0), b && this.subject.onNext(a);
            },
    ...
    Kb.controlled = function(a, b) {
      return a && vb(a) && (b = a, a = !0), null == a && (a = !0), new Bc(this, a, b);
    }, Kb.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var Dc = da.AnonymousObservable = function(a) {
      function b(a) {
        return a && la(a.dispose) ? a : la(a) ? mb(a) : nb;
      }
      function c(a, c) {
      ...
      function d(b, d) {
        function e(a) {
          var d = new Ec(a),
              e = [d, b];
          return zb.scheduleRequired() ? zb.scheduleWithState(e, c) : c(null, e), d;
        }
    ...
    var Gc = da.Subject = function(a) {
      function c(a) {
        return pb(this), this.isStopped ? this.hasError ? (a.onError(this.error), nb) : (a.onCompleted(), nb) : (this.observers.push(a), new Fc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return db(d, a), eb(d.prototype, Nb.prototype, {
        ...
        Hc = da.AsyncSubject = function(a) {
          function c(a) {
            return pb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), nb) : (this.observers.push(a), new Fc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return db(d, a), eb(d.prototype, Nb, {
            hasObservers: function() {
        ...
        Ic = da.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return db(c, a), eb(c.prototype, Nb.prototype, {
            onCompleted: function() {
        ...
        Jc = da.BehaviorSubject = function(a) {
          function c(a) {
            return pb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), nb) : (this.observers.push(a), a.onNext(this.value), new Fc(this, a));
          }
          function d(b) {
        ...
        Kc = da.ReplaySubject = function(a) {
          function c(a, b) {
            return mb(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || zb, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return db(e, a), eb(e.prototype, Nb.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(Gc), "function" == typeof define && "object" == typeof define.amd && define.amd ? ($.Rx = da, define(function() {
      return da;
    })) : _ && aa ? ba ? (aa.exports = da).Rx = da : _.Rx = da : $.Rx = da;
    var Lc = g();
  }).call(this);
})(require("process"));
