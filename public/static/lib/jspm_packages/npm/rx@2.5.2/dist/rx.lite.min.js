...
(function(process) {
 ...
 while (null !== g);
    ...
    var yc = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new zc(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return cb(c, a), c.prototype.request = function(a) {
        ...
        zc = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Dc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = kb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || wb;
          }
          return cb(c, a), db(c.prototype, Kb, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Bb.createOnCompleted()) : this.subject.onCompleted();
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Bb.createOnError(a)) : this.subject.onError(a);
            },
            onNext: function(a) {
              var b = !1;
              0 === this.requestedCount ? this.enableQueue && this.queue.push(Bb.createOnNext(a)) : (-1 !== this.requestedCount && 0 === this.requestedCount-- && this.disposeCurrentRequest(), b = !0), b && this.subject.onNext(a);
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                var d = b._processRequest(c),
                    e = d.numberOfItems;
                d.returnValue || (b.requestedCount = e, b.requestedDisposable = jb(function() {
                  b.requestedCount = 0;
                }));
    ...
    Hb.controlled = function(a, b) {
      return a && sb(a) && (b = a, a = !0), null == a && (a = !0), new yc(this, a, b);
    }, Hb.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    }(Dc), "function" == typeof define && "object" == typeof define.amd && define.amd ? (Z.Rx = ca, define(function() {
      return ca;
