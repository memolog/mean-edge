...
(function(process) {
  (function(a) {
    ...
    function D(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && A(b) ? (b = C(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Wb ? Wb : b) : b;
    }
    function E(a, b) {
      this.observer = a, this.parent = b;
    }
    function F(a, b) {
      return ob(a) || (a = sb), new Yb(b, a);
    }
    function G(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function M(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return da(e) && (e = Pb(e)), (ua(e) || ta(e)) && (e = Xb(e)), e;
      }).concatAll();
    }
    function N(a, b, c) {
      for (var d = 0,
    ...
    var Ua,
        ...
        Za = Y.internals.addRef = function(a, b) {
          return new tc(function(c) {
            return new bb(b.getDisposable(), a.subscribe(c));
          });
        },
        $a = {e: {}};
    ...
    var _a = Y.internals.PriorityQueue = function(a) {
      this.items = new Array(a), this.length = 0;
    },
        ab = _a.prototype;
    ab.isHigherPriority = function(a, b) {
      return this.items[a].compareTo(this.items[b]) < 0;
    }, ab.percolate = function(a) {
    ...
    var db = Y.Disposable = function(a) {
      this.isDisposed = !1, this.action = a || Z;
    };
    db.prototype.dispose = function() {
      this.isDisposed || (this.action(), this.isDisposed = !0);
    };
    var eb = db.create = function(a) {
      return new db(a);
    },
        fb = db.empty = {dispose: Z},
        gb = db.isDisposable = function(a) {
          return a && ea(a.dispose);
        },
        hb = db.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new la;
        },
        ib = Y.SingleAssignmentDisposable = function() {
          this.isDisposed = !1, this.current = null;
        };
    ib.prototype.getDisposable = function() {
      return this.current;
    }, ib.prototype.setDisposable = function(a) {
      if (this.current)
    ...
    var jb = Y.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    jb.prototype.getDisposable = function() {
      return this.current;
    }, jb.prototype.setDisposable = function(a) {
      var b = this.isDisposed;
      if (!b) {
        var c = this.current;
        this.current = a;
    ...
    var kb = Y.RefCountDisposable = function() {
      function a(a) {
      ...
      return a.prototype.dispose = function() {
        ...
        return this.isDisposed ? fb : new a(this);
      }, b;
    }();
    t.prototype.dispose = function() {
      this.scheduler.scheduleWithState(this, u);
    };
    var lb = Y.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || ba, this.disposable = new ib;
    };
    lb.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, lb.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, lb.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, lb.prototype.invokeCore = function() {
      return this.action(this.scheduler, this.state);
    };
    var mb = Y.Scheduler = function() {
      function a(a, b, c, d) {
    ...
    !function(a) {
          ...
          e(b, function(b) {
            var d = !1,
                ...
                g = a.scheduleWithState(b, function(a, b) {
                  return d ? f.remove(g) : e = !0, c(b), fb;
                });
            e || (f.add(g), d = !0);
          });
        }
          ...
          f(b, function(b, e) {
            var f = !1,
                ...
                i = a[c](b, e, function(a, b) {
                  return f ? g.remove(i) : h = !0, d(b), fb;
                });
            h || (g.add(i), f = !0);
          });
        }
      ...
      mb.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, mb.prototype.schedulePeriodicWithState = function(a, b, c) {
    ...
    var pb,
        qb,
        rb = (Y.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        }(), mb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new mb(_, a, qa, qa);
        }()),
        sb = mb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
          ...
          function b(b, d) {
            var e = new lb(this, b, d, this.now());
            if (c)
              c.enqueue(e);
            else {
              c = new _a(4), c.enqueue(e);
              var f = p(a)();
              if (c = null, f === $a)
                return q(f.e);
            }
    ...
    !function() {
      ...
      if (ea(h))
        ...
        T.addEventListener ? T.addEventListener("message", c, !1) : T.attachEvent ? T.attachEvent("onmessage", c) : T.onmessage = c, pb = function(a) {
          var b = d++;
        ...
        pb = "document" in T && "onreadystatechange" in T.document.createElement("script") ? function(b) {
          ...
          var c = d++;
          return e[c] = b, ub(function() {
            a(c);
          }, 0), c;
        };
    }();
    var wb = (mb.timeout = mb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new ib,
            e = pb(function() {
      ...
      return Xa(e, a), e.prototype._clone = function(a) {
        ...
        xb = Y.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return ob(a) || (a = rb), new tc(function(c) {
        ...
        yb = xb.createOnNext = function() {
          ...
          return function(d) {
            return new xb("N", d, null, a, b, c);
          };
        }(),
        zb = xb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new xb("E", null, d, a, b, c);
          };
        }(),
        Ab = xb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new xb("C", null, null, a, b, c);
          };
        }(),
        Bb = Y.internals.Enumerator = function(a) {
          this._next = a;
        };
    ...
    var Cb = Y.internals.Enumerable = function(a) {
      this._iterator = a;
    };
    Cb.prototype[ra] = function() {
      return this._iterator();
    }, Cb.prototype.concat = function() {
      var a = this;
      return new tc(function(b) {
        var c,
            d = a[ra](),
            e = new jb,
            f = rb.scheduleRecursive(function(a) {
              if (!c) {
                try {
                  var f = d.next();
                } catch (g) {
        ...
        return new bb(e, f, eb(function() {
          c = !0;
        }));
      });
    }, Cb.prototype.catchError = function() {
      var a = this;
      return new tc(function(b) {
        var c,
            d = a[ra](),
            e = new jb,
            f = rb.scheduleRecursiveWithState(null, function(a, f) {
              if (!c) {
                try {
                  var g = d.next();
                } catch (h) {
    ...
    }, Cb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new tc(function(c) {
        var d,
            e,
            ...
            j = b[ra](),
            k = new jb,
            l = rb.scheduleRecursive(function(a) {
              if (!d) {
                try {
                  var b = j.next();
                } catch (h) {
                ...
                var l = new ib,
                    m = new ib;
                k.setDisposable(new bb(m, l)), l.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new bb(i, k, l, eb(function() {
          d = !0;
        }));
      });
    };
    var Db = Cb.repeat = function(a, b) {
      return null == b && (b = -1), new Cb(function() {
        var c = b;
        ...
        Fb = Y.Observer = function() {};
    Fb.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, Fb.prototype.asObserver = function() {
      return new Jb(this.onNext.bind(this), this.onError.bind(this), this.onCompleted.bind(this));
    }, Fb.prototype.checked = function() {
      return new Kb(this);
    };
    var Gb = Fb.create = function(a, b, c) {
      return a || (a = Z), b || (b = ca), c || (c = Z), new Jb(a, b, c);
    };
    Fb.fromNotifier = function(a, b) {
      return new Jb(function(c) {
        return a.call(b, yb(c));
      }, function(c) {
        return a.call(b, zb(c));
      }, function() {
        return a.call(b, Ab());
      });
    }, Fb.prototype.notifyOn = function(a) {
      return new Mb(a, this);
    }, Fb.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var Hb,
        Ib = Y.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Jb = Y.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Lb = Y.internals.ScheduledObserver = function(a) {
          function b(b, c) {
            a.call(this), this.scheduler = b, this.observer = c, this.isAcquired = !1, this.hasFaulted = !1, this.queue = [], this.disposable = new jb;
          }
          return Xa(b, a), b.prototype.next = function(a) {
            var b = this;
        ...
        Nb = Y.Observable = function() {
          ...
          return Hb = a.prototype, Hb.subscribe = Hb.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Gb(a, b, c));
          }, Hb.subscribeOnNext = function(a, b) {
            return this._subscribe(Gb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Hb.subscribeOnError = function(a, b) {
            return this._subscribe(Gb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Hb.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Gb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        Ob = Y.ObservableBase = function(a) {
          function b(a) {
            return a && ea(a.dispose) ? a : ea(a) ? eb(a) : fb;
          }
          function c(a, c) {
            var d = c[0],
                e = c[1],
          ...
          function d(a) {
            var b = new uc(a),
                d = [b, this];
            return sb.scheduleRequired() ? sb.scheduleWithState(d, c) : c(null, d), b;
          }
          function e() {
            a.call(this, d);
          }
    ...
    Hb.observeOn = function(a) {
      var b = this;
      return new tc(function(c) {
        return b.subscribe(new Mb(a, c));
      }, b);
    }, Hb.subscribeOn = function(a) {
      var b = this;
      return new tc(function(c) {
        var d = new ib,
            e = new jb;
    ...
    var Pb = Nb.fromPromise = function(a) {
      return Rb(function() {
    ...
    v.prototype.onNext = function(a) {
      ...
      return new Qb(this);
    }, Nb.create = Nb.createWithDisposable = function(a, b) {
      return new tc(a, b);
    };
    var Rb = Nb.defer = function(a) {
      return new tc(function(b) {
        var c;
        try {
          c = a();
        ...
        return da(c) && (c = Pb(c)), c.subscribe(b);
      });
    },
        Sb = function(a) {
          function b(b) {
        ...
        Tb = Nb.empty = function(a) {
          return ob(a) || (a = rb), new Sb(a);
        },
        Ub = function(a) {
          function b(b, c, d) {
    ...
    var Xb = Nb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Zb = Nb.fromArray = function(a, b) {
      return ob(b) || (b = sb), new Yb(a, b);
    };
    Nb.generate = function(a, b, c, d, e) {
      return ob(e) || (e = sb), new tc(function(f) {
        var g = !0;
    ...
    G.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Nb.pairs = function(a, b) {
      return b || (b = sb), new ac(a, b);
    };
    var bc = function(a) {
      function b(b, c, d) {
    ...
    Nb.range = function(a, b, c) {
      return ob(c) || (c = sb), new bc(a, b, c);
    };
    var dc = function(a) {
      function b(b, c, d) {
    ...
    }, Nb.repeat = function(a, b, c) {
      return ob(c) || (c = sb), new dc(a, b, c);
    };
    var ec = function(a) {
      function b(b, c) {
      ...
      return Xa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        fc = (Nb["return"] = Nb.just = Nb.returnValue = function(a, b) {
          return ob(b) || (b = rb), new ec(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        gc = Nb["throw"] = Nb.throwError = Nb.throwException = function(a, b) {
          return ob(b) || (b = rb), new fc(a, b);
        };
    Nb.using = function(a, b) {
      return new tc(function(c) {
        var d,
            e,
            f = fb;
        try {
          ...
          return new bb(gc(g).subscribe(c), f);
        }
        return new bb(e.subscribe(c), f);
      });
    }, Hb.amb = function(a) {
      var b = this;
      return new tc(function(c) {
        ...
        var f,
            ...
            i = new ib,
            j = new ib;
        return da(a) && (a = Pb(a)), i.setDisposable(b.subscribe(function(a) {
          d(), f === g && c.onNext(a);
        }, function(a) {
          d(), f === g && c.onError(a);
        }, function() {
      ...
      return "function" == typeof a ? I(this, a) : hc([this, a]);
    };
    var hc = Nb.catchError = Nb["catch"] = Nb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var ic = Nb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new tc(function(a) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new ib;
            da(f) && (f = Pb(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
      ...
      return Xa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        lc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new ib;
            this.g.add(c), da(a) && (a = Pb(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    var mc = Nb.merge = function() {
      ...
      return Array.isArray(c[0]) && (c = c[0]), F(a, c).mergeAll();
        ...
        nc = Y.CompositeError = function(a) {
    ...
    nc.prototype = Error.prototype, Nb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new tc(function(a) {
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new ib;
          c.add(e), da(d) && (d = Pb(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
      ...
      return Xa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        pc = function() {
          ...
          return a.prototype.onNext = function(a) {
            if (!this.isStopped) {
              var c = new ib;
              this.g.add(c), da(a) && (a = Pb(a)), c.setDisposable(a.subscribe(new b(this, this.g, c)));
            }
          }, a.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, a.prototype.onCompleted = function() {
    ...
    Hb.mergeAll = Hb.mergeObservable = function() {
      return new oc(this);
    }, Hb.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return qc([this, a]);
    };
    var qc = Nb.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new tc(function(b) {
        var c = 0,
            d = new jb,
            e = rb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], da(f) && (f = Pb(f)), g = new ib, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new bb(d, e);
      });
    };
    Hb.skipUntil = function(a) {
      ...
      return new tc(function(c) {
        var d = !1,
            e = new bb(b.subscribe(function(a) {
              d && c.onNext(a);
            }, function(a) {
              c.onError(a);
            }, function() {
      ...
      return new tc(function(b) {
        var c = !1,
            ...
            g = a.subscribe(function(a) {
              var g = new ib,
                  h = ++f;
              c = !0, d.setDisposable(g), da(a) && (a = Pb(a)), g.setDisposable(a.subscribe(function(a) {
                f === h && b.onNext(a);
              }, function(a) {
                f === h && b.onError(a);
              }, function() {
      ...
      var b = this;
      return new tc(function(c) {
        return da(a) && (a = Pb(a)), new bb(b.subscribe(c), a.subscribe(function() {
          c.onCompleted();
        }, function(a) {
          c.onError(a);
        }, Z));
      ...
      return Array.isArray(b[0]) && (b = b[0]), new tc(function(a) {
        for (var c = function() {
          ...
          !function(c) {
            var d = b[c],
                e = new ib;
            da(d) && (d = Pb(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      return b.unshift(d), new tc(function(a) {
        ...
        for (var g = b.length,
          ...
          !function(d) {
            var e = b[d],
                g = new ib;
            da(e) && (e = Pb(e)), g.setDisposable(e.subscribe(function(a) {
              h[d].push(a), c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
      ...
      return new tc(function(b) {
        ...
        for (var e = a.length,
            ...
            i = 0; e > i; i++)
          !function(e) {
            h[e] = new ib, h[e].setDisposable(a[e].subscribe(function(a) {
              f[e].push(a), c(e);
            }, function(a) {
              b.onError(a);
            }, function() {
    ...
    }, Hb.bufferWithCount = function(a, b) {
      ...
      var c = this;
      return b || (b = aa), new tc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
      ...
      return new tc(function(b) {
        return a.subscribe(function(a) {
          ...
          b.onNext(zb(a)), b.onCompleted();
        }, function() {
          b.onNext(Ab()), b.onCompleted();
        });
      }, a);
    }, Hb.repeat = function(a) {
      return Db(this, a).concat();
    }, Hb.retry = function(a) {
      return Db(this, a).catchError();
    }, Hb.retryWhen = function(a) {
      return Db(this).catchErrorWhen(a);
    }, Hb.scan = function() {
      var a,
          b,
          c = !1,
      ...
      var a,
          b = 0;
      arguments.length && ob(arguments[0]) ? (a = arguments[0], b = 1) : a = rb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Eb([Zb(c, a), this]).concat();
    ...
    }, Hb.windowWithCount = function(a, b) {
      var c = this;
      ...
      return ea(a) && ea(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return da(e) && (e = Pb(e)), (ua(e) || ta(e)) && (e = Xb(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : ea(a) ? M(this, a, c) : M(this, function() {
        return a;
      });
    }, Hb.concatMapObserver = Hb.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = wa(a, d, 2),
          g = wa(b, d, 1),
          h = wa(c, d, 0);
      return new tc(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          da(c) && (c = Pb(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          da(b) && (b = Pb(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, Hb.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new tc(function(a) {
        var d = !1;
    ...
    P.prototype.onNext = function(a) {
      ...
      return this instanceof rc ? this.internalMap(c, b) : new rc(this, c, b);
    }, Hb.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, Hb.flatMapObserver = Hb.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new tc(function(f) {
        ...
        return e.subscribe(function(b) {
          ...
          da(c) && (c = Pb(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          da(a) && (a = Pb(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    ...
    R.prototype.onNext = function(a) {
      ...
      return this instanceof sc ? this.internalFilter(a, b) : new sc(this, a, b);
    ...
    var tc = Y.AnonymousObservable = function(a) {
      function b(a) {
        return a && ea(a.dispose) ? a : ea(a) ? eb(a) : fb;
      }
      function c(a, c) {
      ...
      function d(b, d) {
        function e(a) {
          var d = new uc(a),
              e = [d, b];
          return sb.scheduleRequired() ? sb.scheduleWithState(e, c) : c(null, e), d;
        }
      ...
      return Xa(d, a), d;
        ...
        uc = function(a) {
          function b(b) {
            a.call(this), this.observer = b, this.m = new ib;
          }
          Xa(b, a);
          var c = b.prototype;
    ...
    var wc = Y.Subject = function(a) {
      function c(a) {
        return hb(this), this.isStopped ? this.hasError ? (a.onError(this.error), fb) : (a.onCompleted(), fb) : (this.observers.push(a), new vc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return Xa(d, a), Ya(d.prototype, Fb.prototype, {
        hasObservers: function() {
          return this.observers.length > 0;
        },
        onCompleted: function() {
          if (hb(this), !this.isStopped) {
            this.isStopped = !0;
            for (var a = 0,
                c = b(this.observers),
                d = c.length; d > a; a++)
        ...
        xc = (Y.AsyncSubject = function(a) {
          function c(a) {
            return hb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), fb) : (this.observers.push(a), new vc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return Xa(d, a), Ya(d.prototype, Fb, {
            hasObservers: function() {
              return hb(this), this.observers.length > 0;
            },
            onCompleted: function() {
              var a,
                  c;
            ...
            onNext: function(a) {
              hb(this), this.isStopped || (this.value = a, this.hasValue = !0);
            },
            dispose: function() {
              this.isDisposed = !0, this.observers = null, this.exception = null, this.value = null;
            }
          }), d;
        }(Nb), Y.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Xa(c, a), Ya(c.prototype, Fb.prototype, {
            onCompleted: function() {
