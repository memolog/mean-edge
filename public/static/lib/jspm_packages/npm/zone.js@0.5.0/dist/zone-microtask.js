  ...
  (function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
      (function(global) {
        ...
        var es6Promise = require("../ext/es6-promise");
        if (global.Zone) {
      ...
      (function(global) {
        ...
        function apply() {
          if (global.EventTarget) {
            ...
            var apis = ['ApplicationCache', 'EventSource', 'FileReader', 'InputMethodContext', 'MediaController', 'MessagePort', 'Node', 'Performance', 'SVGElementInstance', 'SharedWorker', 'TextTrack', 'TextTrackCue', 'TextTrackList', 'WebKitNamedFlow', 'Window', 'Worker', 'WorkerGlobalScope', 'XMLHttpRequestEventTarget', 'XMLHttpRequestUpload'];
